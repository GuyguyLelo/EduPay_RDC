...
ALLOWED_HOSTS = config('ALLOWED_HOSTS', default='localhost,127.0.0.1,testserver,edupay-rdc-p9tw.onrender.com,onrender.com', cast=lambda v: [s.strip() for s in v.split(',')])
